...
public :
  ...
  static constexpr float alingment_cf[2][kMaxLayers] = {
    { 0.0f, 0.0f, -1.07f,  0.0f,  -2.69f, -2.70f},
    { 0.0f, 0.0f,  0.0f,  -1.92f, -3.66f, -3.74f}
    //{0.0f, 0.0f, -0.83,  0.0f, -2.41, -2.24},
    //{0.0f, 0.0f,  0.0f, -1.44, -3.01, -3.42}
  };

  static constexpr float fiducial_vol_min[2][kMaxLayers] = {
    { -2.0f, -2.0f, -2.0f,  -2.0f, 3.19f, 3.20f},
    { -2.0f, -2.0f, -2.0f,  -2.0f, 4.16f, 4.74f}
  };
  static constexpr float fiducial_vol_max[2][kMaxLayers] = {
    { 6.0f, 6.0f, 6.0f,  6.0f, 4.19f, 4.20f},
    { 6.0f, 6.0f, 6.0f,  6.0f, 5.16f, 5.24f}
  };
  ...
  */
  ...
  // 2D histograms
  TH2F* h2_max_charge_sum_charge[kMaxLayers] = {nullptr};
  ...
  // 2D hit maps
  TH2F* h2_DUT_map[kMaxLayers] = {nullptr};
  TH2F* h2_DUT_extrap_map[kMaxLayers] = {nullptr};
